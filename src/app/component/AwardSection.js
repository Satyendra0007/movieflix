...
export default function AwardSection({ wins, nomination, award, awardCount, winCount }) {
  return (
    <section className='py-2'>
      <div className=" awards p-5 bg-gray-100">
        <div className=' border border-yellow-500  shadow-md'>
          ...
          <div className="p-3">
            <p className='font-bold'>Nominated for {awardCount} {award} {winCount && ` and win ${winCount}`}</p>
