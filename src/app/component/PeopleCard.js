...
export default function PeopleCard({ elem }) {
  ...
  return (
    <div className='card p-4 bg-gray-50 border border-gray-400 rounded-md shadow-full w-56'>
      <div className="image ">
        <Image className='w-24 h-24 mx-auto rounded-full' src={elem.avatarImageModel ? elem.avatarImageModel.url : altImage} height={100} width={100} alt="image" priority={true}></Image>
      </div>
